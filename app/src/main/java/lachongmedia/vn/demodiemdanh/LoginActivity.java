...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new DiemdanhAdapter(DbContext.instance.getStudents());
        rvClass.setAdapter(adapter);
        rvClass.setLayoutManager(new LinearLayoutManager(this));
        tvTotal.setText("Số học sinh: 0/"+DbContext.instance.getStudents().size());
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition()==0){
                    ...
                    adapter=new DiemdanhAdapter(DbContext.instance.getStudentCheck());
                    rvClass.setAdapter(adapter);
                }else {
                    adapter=new DiemdanhAdapter(DbContext.instance.getStudentUnCheck());
                    rvClass.setAdapter(adapter);
                }
    ...
    protected void onNewIntent(Intent intent) {
        if (intent.getAction().equals(NfcAdapter.ACTION_TAG_DISCOVERED)) {
            ...
            if (student!=null){
                ...
                tvTotal.setText("Số học sinh: "+DbContext.instance.countStudentnow()+'/'+DbContext.instance.getStudents().size());
            }
