...
public class DiemdanhThiActivity extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    @BindView(R.id.bt_goUnit)
    CircleButton btGoUnit;
    DiemDanhthiAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_diemdanh_thi);
        ...
        tvTotal.setText("Đã nộp bài: 0/"+DbContext.instance.getStudents().size());
        ...
        btGoUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog dialog=new AlertDialog.Builder(DiemdanhThiActivity.this)
                        .setNegativeButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent=new Intent(DiemdanhThiActivity.this,UnitTestActivity.class);
                        ...
                        }).setMessage("Xác nhận đã điểm danh thi xong?")
                        .setTitle("Chuyển sang nộp bài thi")
                        .show();
    ...
    protected void onNewIntent(Intent intent) {
        if (intent.getAction().equals(NfcAdapter.ACTION_TAG_DISCOVERED)) {
            ...
            if (student!=null){
                ...
                tvTotal.setText("Đã nộp bài: "+DbContext.instance.countStudentnow()+'/'+DbContext.instance.getStudents().size());
            }
